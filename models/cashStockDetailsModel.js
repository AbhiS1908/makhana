...
const CashStockDetailsSchema = new mongoose.Schema({
    ...
    finalPrices: [{ type: Number }], // Include finalPrices in the schema
...
CashStockDetailsSchema.pre('save', function (next) {
...
module.exports = mongoose.model('CashStockDetails', CashStockDetailsSchema);
