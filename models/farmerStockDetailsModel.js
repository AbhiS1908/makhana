...
const FarmerStockDetailsSchema = new mongoose.Schema({
...
FarmerStockDetailsSchema.pre('save', function (next) {
...
module.exports = mongoose.model('FarmerStockDetails', FarmerStockDetailsSchema);
